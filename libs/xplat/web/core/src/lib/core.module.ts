...
export function platformLangFactory() {
	const browserLang = window.navigator.language || 'cn'; // fallback English
...
export class FyCoreModule {
	constructor(
		@Optional()
		@SkipSelf()
		parentModule: FyCoreModule
	) {
		throwIfAlreadyLoaded(parentModule, 'FyCoreModule');
	}
}
