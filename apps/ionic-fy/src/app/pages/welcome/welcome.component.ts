...
export class WelcomeComponent extends BaseComponent implements OnInit {
	...
	async ngOnInit() {
		...
		const fetchVideoConstant = this.dataFetchService.fetchTopicList(this.dataFetchService.videoConstantUrl)
		const fetchAudioConstant = this.dataFetchService.fetchTopicList(this.dataFetchService.audioConstantUrl)
		await Promise.all([fetchVideoConstant, fetchAudioConstant])
