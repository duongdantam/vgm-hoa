...
export class HomePage implements OnInit {
	...
	async init() {
		this.videoConstantList = await this.dataFetchService.fetchTopicList('07-sheng-jing-jiang-jie.du-sheng-jing-xi-lie').then(async topic => {
		...
		this.audioConstantList = await this.dataFetchService.fetchTopicList('xin-tu-sheng-huo.02-tian-tian-qin-jin-zhu')
